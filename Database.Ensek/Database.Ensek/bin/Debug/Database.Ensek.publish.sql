...
GO
PRINT N'Dropping [dbo].[Meter_Readings].[IX_MeterReading_AccountId]...';


GO
DROP INDEX [IX_MeterReading_AccountId]
    ON [dbo].[Meter_Readings];


GO
PRINT N'Starting rebuilding table [dbo].[Meter_Readings]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Meter_Readings] (
    [Id]                   INT           NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Meter_Readings] ([Id], [AccountId], [MeterReadingDateTime], [MeterReadValue])
        SELECT   [Id],
                 [AccountId],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Meter_Readings]', N'Meter_Readings';
...
GO
PRINT N'Starting rebuilding table [dbo].[Test_Accounts]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Test_Accounts] (
    [AccountId] INT          NOT NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Test_Accounts])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Test_Accounts] ([AccountId], [FirstName], [LastName])
        SELECT   [AccountId],
                 [FirstName],
                 [LastName]
        FROM     [dbo].[Test_Accounts]
...
DROP TABLE [dbo].[Test_Accounts];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Test_Accounts]', N'Test_Accounts';
